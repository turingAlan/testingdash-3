...
const CustomInputVerticalDelivery = (props: CustomInputVerticalProps) => {
  // Props
      ...
      <Grid item {...gridProps}>
        ...
        >
          {typeof asset === 'string' ? (
            <Image
              src={asset}
              alt={(title as string) ?? `checkbox-image-${title as string}`}
              width={80}
              height={80}
...
export default CustomInputVerticalDelivery
